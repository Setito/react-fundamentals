...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=01%3A%20Basic%20JavaScript-rendered%20Hello%20World&em=setmaxo%40gmail.com).

## WhatI've learned

I reminded briefly how modules works and some different ways to write the
modules using raw JS, classes, etc.

Then I read about the DOM and its API to create new elements and append them to
alter the HTML. Also, how to update its content, class and id.

Finally, I discovered that document.getElementByTagName('body') doesn't work. I
ran document.body in order to get the body HTML tag instead.
